...
export declare const AAD_DEFAULT_SCOPE = "https://cosmos.azure.com/.default";
export declare const AAD_AUTH_PREFIX = "type=aad&ver=1.0&sig=";
export declare const AAD_RESOURCE_NOT_FOUND_ERROR = "AADSTS500011";
/**
 * @hidden
 */
